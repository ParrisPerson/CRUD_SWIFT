...
class Decoders {
    ...
    private static var __once: () = {
        ...
        Decoders.addDecoder(clazz: User.self) { (source: AnyObject) -> User in
            ...
            let instance = User()
            instance.id = Decoders.decodeOptional(clazz: Int.self, source: sourceDictionary["id"] as AnyObject?)
            instance.name = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["name"] as AnyObject?)
            instance.birthdate = Decoders.decodeOptional(clazz: Date.self, source: sourceDictionary["birthdate"] as AnyObject?)!
            return instance
        }
    }()
